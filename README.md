...
```
    ...
    ║     ╚═════╝ ╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝        ║
    ║                                                               ║
    ║              🛡️  C O M P L I A N C E - A W A R E  🛡️           ║
    ║                                                               ║
    ║     ┌─────────┐    ┌───────────┐    ┌─────────────┐           ║
    ║     │ REQUEST │───►│ COMPLIANCE│───►│  PROVIDER   │           ║
    ║     │         │    │  GATEWAY  │    │             │           ║
    ║     │ OpenAI  │    │ PII ░▒▓█  │    │  Anthropic  │           ║
    ║     │ format  │    │ Residency │    │  Azure      │           ║
    ║     │         │    │ Tier      │    │  OpenAI     │           ║
    ║     └─────────┘    └───────────┘    └─────────────┘           ║
    ║                                                               ║
    ║        "Point your tools at the broker. Forget compliance."   ║
    ║                                                               ║
    ╚═══════════════════════════════════════════════════════════════╝
```
